import type { DrawPoint } from '../model/types';

/**
 * Утилиты для работы с полигонами
 * Перенесены из src/components/features/location-filter/draw/utils/polygonHelpers.ts
 */
