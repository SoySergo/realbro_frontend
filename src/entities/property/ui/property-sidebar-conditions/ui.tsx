            ...
            <div className="space-y-6">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <span className="text-3xl font-bold">
                                {formatPrice(price)} {currency}/мес.
                            </span>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Input 
                            placeholder={`Например, ${formatPrice(Math.round(price * 0.9))} ${currency}`}
                            value={offerPrice}
                            onChange={(e) => setOfferPrice(e.target.value)}
                            className="bg-muted/30"
                        />
                        <Button size="icon" variant="secondary" className="bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-blue-950 dark:text-blue-400 aspect-square h-auto w-10 shrink-0">
                    ...
                    <div className="flex justify-between items-end gap-2">
                        ...
                        <span className="text-right font-medium text-nowrap">
                            {rentalConditions?.minRentalMonths 
                                ? `от ${rentalConditions.minRentalMonths} мес.` 
                                : (t('longTerm') || 'от года')
                            }
                        </span>
                    </div>
                ...
                <div className="space-y-3">
                    <Button 
                        size="lg" 
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold text-lg h-12 shadow-md shadow-blue-900/10"
                        onClick={onCall}
                    >
                    ...
                    <Button 
                        size="lg" 
                        variant="secondary"
                        className="w-full text-lg h-12 bg-blue-50 text-blue-700 hover:bg-blue-100 dark:bg-blue-950 dark:text-blue-300"
                        onClick={onMessage}
                    >
