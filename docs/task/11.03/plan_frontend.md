...
3. **Контейнер не залезает на логотип:**
   ...
   - в случае если кнопки не влазят, то не обрезать их скрывая за горизонтом часть. А вообще убирать. Все кнопки которые не влазят у нас дублируются в полных фильтрах
